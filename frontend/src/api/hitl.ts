...
export function listThreads(params: ListThreadsParams = {}): Promise<ThreadListResponse> {
  ...
  const qs = q.toString();
  return apiGet<ThreadListResponse>(`/hitl/threads${qs ? `?${qs}` : ''}`);
}

export function getThread(id: string): Promise<HitlThread & { messages: HitlMessage[] }> {
  return apiGet(`/hitl/threads/${encodeURIComponent(id)}`);
}
...
export function listMessages(
  ...
  if (params.offset != null) q.set('offset', String(params.offset));
  const qs = q.toString();
  return apiGet(`/hitl/threads/${encodeURIComponent(id)}/messages${qs ? `?${qs}` : ''}`);
}

export function createThread(body: CreateThreadRequest): Promise<HitlThread> {
  return apiPost('/hitl/threads', body);
}

export function addMessage(id: string, body: AddMessageRequest): Promise<HitlMessage> {
  return apiPost(`/hitl/threads/${encodeURIComponent(id)}/messages`, body);
}

export function selectOption(id: string, body: OptionSelectRequest): Promise<HitlMessage> {
  return apiPost(`/hitl/threads/${encodeURIComponent(id)}/option-select`, body);
}
...
export function resolveThread(
  ...
  return apiPost(`/hitl/threads/${encodeURIComponent(id)}/resolve`, body);
}
...
export function escalateThread(
  ...
  return apiPost(`/hitl/threads/${encodeURIComponent(id)}/escalate`, body);
}
